# Generated by Django 6.0.4 on 2026-04-23 16:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(blank=True, help_text='Bootstrap Icons class, e.g. bi-camera', max_length=60)),
                ('color', models.CharField(default='#2563eb', help_text='CSS hex color for the category accent', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(blank=True, help_text='Brief description shown in listings', max_length=500)),
